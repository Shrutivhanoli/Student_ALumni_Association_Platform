...
<div style="width:100%;height:140px;background-color:red;margin-bottom:50px">
        ...
        <a href="http://localhost/database_gallery/uploadimage.html" style="text-decoration:none;color:white;font-size:25px;position:absolute;right:30px;top:60px">Add Images</a>
    </div>
