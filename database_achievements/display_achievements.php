...
<body>
    <div style="height:150px;width:100%;background-color:red;margin-bottom:30px">
    <img src="https://www.shutterstock.com/image-vector/dark-blue-abstract-concept-polygonal-600nw-562046032.jpg" alt="image" style="height:150px;width:100%">
    <h2 style="width:135px;position:relative;left:30px;bottom:140px;font-size:44px;color:white;padding:8px;border-bottom:5px solid orangered "> Achievements</h2>
    </div>
    <div class="achievement-container">
        <?php
        if ($result->num_rows > 0) {
            // Output each achievement as a box
            while($row = $result->fetch_assoc()) {
                echo "<div class='achievement-box'>";
                // Dynamically use the correct image path from the database
                echo "<img src='" . $row['image_path'] . "' alt='Achievement Image'>"; 
                echo "<div class='achievement-details'>";
                echo "<h3>" . $row['student_name'] . "</h3>";
                echo "<p><strong>" . $row['achievement_title'] . "</strong></p>";
                echo "<p>" . $row['achievement_description'] . "</p>";
                echo "<p class='date'>" . $row['date_achieved'] . "</p>";
                echo "</div>";
                echo "</div>";
            }
        } else {
    ...
    <!--
    <div style="height:50px;width:240px;background-color:red;position:relative;left:950px;border-radius:15px;top:20px">
        <a href="upload_achi.html" style="text-decoration:none;font-size:22px;color:white;position:relative;left:29px;top:13px">Add Achievements</a>
    </div>
    -->
